    ...
    try {
      ...
      const { data: dropData, error: dropError } = await supabase
        ...
        .select(`
          ...
          location_type, location_name, location_address, location_lat, location_lng,
          location_radius_m, location_provider_id,
